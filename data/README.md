...
Git does not protect these local inputs or outputs. Backup of the review bundle to an external drive was agreed 2026-09-15 and is not yet done; record the drive and path here once copied. `outputs/` runs, including grouped summaries and HTML pages, are regenerable from the commands in the README and are not backed up.
