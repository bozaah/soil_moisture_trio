...
Bounded Albany profiling supports 10×10 target tiles with a 256 MiB cache, not a whole-SWAZ performance guarantee. The command and restart mechanism exist. Rodrigo's [2026-08-31 waiver](../sessions/2026-08-31-swaz-review-build-waiver.md) authorises a review-input build only. External review and distribution/release approvals remain outstanding. Neither the artifact nor checkpoints exist locally as of 2026-09-11.

Git does not protect these local inputs or outputs. Off-machine backup was not verified in the 2026-09-11 check.
